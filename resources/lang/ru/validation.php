...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'products' => [
            'required' => 'В корзине должны быть товары'
        ],
        'order.comment' => [
            'required' => 'Комментарий обязательный к заполнению'
        ],
        'order.surname' => [
            'required' => 'Фамилия обязательный к заполнению',
            'regex' => 'Фамилия имеет ошибочный формат.'
        ],
        'order.middle_name' => [
            'required' => 'Отчество обязательный к заполнению'
        ],
        'order.name' => [
            'required' => 'Имя обязательный к заполнению',
            'regex' => 'Имя имеет ошибочный формат.'
        ],
    ],
