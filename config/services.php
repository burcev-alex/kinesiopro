...
return [
    ...
    */
    ...
    /*
     * НАСТРОЙКИ САЙТА EKOJ.COM.UA 
    */
    'support' => [
        'email' => env('SUPPORT_EMAIL', 'info@ekoj.com.ua')
    ],

    'fixel' => [
        'init' => (bool) env('CONNECT_FB_PIXEL', false), // интеграция с FB Pixel
    ],

    'google-analitics' => [
        'init' => (bool) env('CONNECT_GOOGLE_ANALITICS', false), // интеграция с GA
    ],

    'tiktok' => [
        'init' => (bool) env('CONNECT_TIKTOK', false), // интеграция с TikTok
    ]
