...
return [
    ...
    */
    'bots'                         => [
        'artline' => [
            'username'            => 'ArtlineSupportBot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '5189126535:AAHGuzNMcvDekL5SftiJIAdxVU5GEEXmXRU'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://artline.ac-step.com/api/v2/telegram/hooks'),
            'commands'            => [
    ...
    */
    ...
    'users_chat' => env('TELEGRAM_BOT_USER_CHATS', '240191897'),
