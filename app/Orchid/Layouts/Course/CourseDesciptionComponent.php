...
/**
 * CourseDesciptionComponent
 */
class CourseDesciptionComponent extends Rows
{
    /**
    ...
    protected $component;
    protected $prefix;
    protected $defNamespace = 'App\Orchid\Layouts\Course\Components';
     ...
     * его blade-component-слагу (<x-news.text-title/>) класс в пространстве имен App\Orchid\Layouts\Course\Components
     * (пример: text-title - App\Orchid\Layouts\Course\Components\TextTitle).
     *
     * Если класса не будет, то компонент проигнорируется в админ панели
     * и заложится ошибка.
     *
     * Каждый компонент должен расширять этот класс и
     * имплиментировать App\Orchid\Layouts\Course\Interfaces\CourseDesciptionComponentInterface
     * что бы успешно попасть в метод $this->makeComponent()
     *
     * @param  AppCourseDesciptionComponent $component
     * @return void
     */
    public function __construct(AppCourseDesciptionComponent $component)
    {
     ...
     *
     * @param  CourseDesciptionComponentInterface $component
     * @return array
     */
    public function makeComponent(CourseDesciptionComponentInterface $component): array
    {
